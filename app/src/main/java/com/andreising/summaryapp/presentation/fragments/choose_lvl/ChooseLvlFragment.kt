 ...
 * Use the [ChooseLvlFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ChooseLvlFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ChooseLvlFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ChooseLvlFragment().apply {
